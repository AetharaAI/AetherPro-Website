...
const AETHERPRO_API_BASE_URL = import.meta.env.VITE_API_URL || 'http://localhost:8000/api/v1'; // For local development
const AETHERPRO_WS_BASE_URL = import.meta.env.VITE_WS_URL || 'ws://localhost:8000/ws/chat';   // For local development
