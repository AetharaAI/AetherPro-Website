...
export const API_BASE_URL = import.meta.env.VITE_APP_API_BASE_URL || 'http://localhost:8000';
// You might also have a frontend base URL here if needed, e.g., for self-redirects
export const FRONTEND_BASE_URL = import.meta.env.VITE_APP_FRONTEND_BASE_URL || 'http://localhost:5173';
